...
export function ProductCard({
  ...
  return (
    <article className="store-product-card group relative flex flex-col overflow-hidden rounded-xl bg-card ring-1 ring-foreground/10">
      {showWishlistButton && (
        ...
        <div className="relative aspect-square w-full overflow-hidden bg-muted">
          {product.imageUrl ? (
            <Image
              ...
              className="store-product-image object-cover"
            />
          ) : null}
          {!product.inStock && (
