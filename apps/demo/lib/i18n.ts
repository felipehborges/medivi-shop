...
export const demoCopy: Record<string, string> = {
  ...
  "Product images": "Imagens do produto", "Photo": "Foto", "Show image": "Mostrar imagem", "of": "de", "Photos repeat in this demo; the zoom works on every selection.": "As fotos se repetem nesta demo; o zoom funciona em todas as seleções.",
